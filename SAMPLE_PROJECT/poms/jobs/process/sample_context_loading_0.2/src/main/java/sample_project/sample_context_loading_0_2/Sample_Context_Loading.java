...
package sample_project.sample_context_loading_0_2;
...
/**
 * Job: Sample_Context_Loading Purpose: Sample_Context_Loading<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Sample_Context_Loading implements TalendJob {
	...
	private final String jobName = "Sample_Context_Loading";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_m-3lIFs7EeyUK6I86sKehw", "0.2");
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Sample_Context_Loading.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Sample_Context_Loading.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static void main(String[] args) {
		final Sample_Context_Loading Sample_Context_LoadingClass = new Sample_Context_Loading();

		int exitCode = Sample_Context_LoadingClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Sample_Context_Loading.class.getClassLoader().getResourceAsStream(
					"sample_project/sample_context_loading_0_2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Sample_Context_Loading.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Sample_Context_Loading");
		}
		if (enableLogStash) {
