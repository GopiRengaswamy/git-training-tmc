...
public class Sample_GIT_Job implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Sample_GIT_Job.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Sample_GIT_Job.class);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Sample_GIT_Job.class.getClassLoader()
					.getResourceAsStream("sample_project/sample_git_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Sample_GIT_Job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Sample_GIT_Job");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 32650 characters generated by Talend Big Data Platform on the December 12,
 * 2021 10:46:05 PM SGT
 ************************************************************************************************/